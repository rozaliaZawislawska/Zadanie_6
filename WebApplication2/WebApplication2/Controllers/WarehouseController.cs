...
public class WarehouseController : ControllerBase
{
    ...
    [HttpPost]
    [Route("/api/[controller]/proc")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status409Conflict)]
    public async Task<IActionResult> RegisterProductInWarehouseByProcedure([FromBody] RegisterProductInWarehouseRequestDTO dto)
    {
        _warehouseService.RegisterProductInWarehouseByProcedureAsync(dto);
        return Ok();
    }
}